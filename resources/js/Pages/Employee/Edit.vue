...
onMounted(() => {
    if(props.user) {
        ...
        user_form.password = props.user.password;
    ...
    if(props.employee) {
        employee_form.employee_number = props.employee.employee_number;
        employee_form.job_title = props.employee.job_title;
        employee_form.hired_at = new Date(props.employee.hired_at);
        employee_form.position = props.employee.position;
...
const submitEmployeeUpdate = (nextStep) => {
    employee_form
    .transform((data) => ({
        ...data,
        user: userRef.value,
